<template>
  <div class="header border-b relative flex flex-col lg:flex-row">
    <img src="/photoholder.jpg" width="120" class="mx-4 mt-4 object-contain lg:m-6 rounded-full" />
    <div class="flex flex-col justify-between relative w-full px-6 pb-6 pt-4 gap-y-3 lg:border-l lg:gap-y-0 lg:p-6">
      <div class="flex flex-col items-center lg:block">
        <p class="text-md font-semibold text-left">Reyven S. Biloy</p> 
        <p class="text-gray-700 text-md">UI/UX Designer</p>
        <div class="flex items-center mt-2">
          <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="graduation-cap" role="img"
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"
            class="mr-2 text-gray-700 svg-inline--fa fa-graduation-cap fa-fw">
          ...
          <p class="text-gray-700">Bachelors of Science in Computer Science</p>
        </div>
      </div>
      <div class="header__other-details flex flex-col gap-3 lg:flex-row lg:items-center">
        <div class="flex items-center"><svg aria-hidden="true" focusable="false"
            data-prefix="fal" data-icon="briefcase" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
            class="mr-2 text-gray-700 svg-inline--fa fa-briefcase fa-fw">
            <path fill="currentColor"
        ...
        <p class="text-gray-700">12 years</p>
      </div>
      <div class="flex items-center"><svg aria-hidden="true" focusable="false"
          data-prefix="fal" data-icon="calendar-check" role="img" xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512" class="mr-2 text-gray-700 svg-inline--fa fa-calendar-check fa-fw">
          <path fill="currentColor"
      ...
      <div class="flex items-center"><svg aria-hidden="true" focusable="false"
          data-prefix="fal" data-icon="circle-dollar" role="img" xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512" class="mr-2 text-gray-700 svg-inline--fa fa-circle-dollar fa-fw">
          <path fill="currentColor"
        ...
        <p class="text-green-500">Php 35,000</p>
      </div>
    </div>
  </div>
</div></template>